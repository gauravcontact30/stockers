...
const workspace = [
  {
    ...
    items: [
      ...
      { href: "/dashboard#buy-tomorrow", label: "Outperform Tomorrow", blurb: "Names set up for tomorrow's session, scored overnight.", tint: CARD_TINTS.indigo },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard#mtf", label: "MTF Watch", blurb: "Most-traded names you can outperform on margin, and the cost.", tint: CARD_TINTS.orange },
